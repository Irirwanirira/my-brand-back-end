...
describe('Auth Middleware', () => {
    ...
    it('should return forbidden if token is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        jsonwebtoken_1.default.verify = jest.fn().mockImplementation((token, secretOrPublicKey, callback) => {
        ...
        expect(res.json).toHaveBeenCalledWith({ status: 'fail', message: 'Invalid token, Error' });
        expect(next).not.toHaveBeenCalled();
    }));
});
